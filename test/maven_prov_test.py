...
class TestMavenProv(unittest.TestCase):
    ...
    def test_fuzzed_3256(self, stdout, stderr, return_value):
        self.assertEquals(return_value, 0)
        self.assertEquals(stdout, "mvn(org.lbzip2:parent)\n")
    ...
    def test_fuzzed_3261(self, stdout, stderr, return_value):
        self.assertEquals(return_value, 0)
        self.assertEquals(stdout, "mvn(org.lbzip2:parent:xyzzy:)\n")
    ...
    def test_fuzzed_3277(self, stdout, stderr, return_value):
        self.assertEquals(return_value, 0)
        self.assertEquals(stdout, "mvn(org.lbzip2:parent::tests:)\n")
    ...
    def test_fuzzed_3282(self, stdout, stderr, return_value):
        self.assertEquals(return_value, 0)
        self.assertEquals(stdout, "mvn(org.lbzip2:parent:xyzzy:tests:)\n")
