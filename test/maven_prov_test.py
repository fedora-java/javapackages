...
class TestMavenProv(unittest.TestCase):
    ...
    def test_multi_ns(self, stdout, stderr, return_value):
        ...
        self.assertEquals(stdout, "ns-mvn(org.codehaus.plexus:plexus-ant-factory:1.0) = 1.0\n"
                          "ns-mvn(org.codehaus.plexus:plexus-ant-factory:pom:1.0) = 1.0\n"
                          "ns2-mvn(org.mortbay.jetty:jsp-2.1-glassfish:1.0) = 9.1.1.b60.25.p2\n"
                          "ns2-mvn(org.mortbay.jetty:jsp-2.1-glassfish:pom:1.0) = 9.1.1.b60.25.p2\n")
    ...
    def test_more_files(self, stdout, stderr, return_value):
        ...
        self.assertEquals(stdout, "ns-mvn(org.codehaus.plexus:plexus-ant-factory:1.0) = 1.0\n"
                          ...
                          "ns-mvn(org.mortbay.jetty:jsp-2.1-glassfish:pom:6.0.18) = 9.1.1.b60.25.p2\n")
